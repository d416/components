...
public class KinesisInputDefinition extends AbstractComponentDefinition {
    ...
    public static final String RUNTIME_1_0 = "org.talend.components.kinesis.runtime_1_0.KinesisInputRuntime";

    public KinesisInputDefinition() {
        super(NAME, ExecutionEngine.BEAM);
    }

    @Override
    public Class<? extends ComponentProperties> getPropertyClass() {
        return KinesisInputProperties.class;
    }
    ...
    public RuntimeInfo getRuntimeInfo(ExecutionEngine engine, ComponentProperties properties, ConnectorTopology topology) {
        ...
        try {
            return new JarRuntimeInfo(new URL("mvn:org.talend.components/kinesis-runtime"),
                    DependenciesReader.computeDependenciesFilePath("org.talend.components", "kinesis-runtime"), RUNTIME_1_0);
