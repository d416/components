...
public class KinesisInputDefinitionTest {
    ...
    /**
     * Check {@link KinesisInputDefinition#getRuntimeInfo(ComponentProperties, ConnectorTopology)} returns RuntimeInfo,
     * which runtime class name is "org.talend.components.kinesis.runtime_1_0.KinesisInputRuntime"
     */
    @Test
    @Ignore("This can't work unless the runtime jar is already installed in maven!")
    public void testRuntimeInfo() {
        RuntimeInfo runtimeInfo = inputDefinition.getRuntimeInfo(ExecutionEngine.BEAM, null, null);
        assertEquals("org.talend.components.kinesis.runtime_1_0.KinesisInputRuntime", runtimeInfo.getRuntimeClassName());
